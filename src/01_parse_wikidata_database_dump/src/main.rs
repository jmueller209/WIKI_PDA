...
use shared::txt_file_processing;
...
const MAX_TEST_LINES: Option<usize> = None; // Entire file has about 120_000_000 lines. 
...
fn main() {
    ...
    if args.len() < 2 {
        eprintln!("Usage: ./path/to/01_parse_wikipedia_database_dump <path_to_config.toml>");
        process::exit(1);
    }
